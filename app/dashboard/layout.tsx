...
import { LayoutDashboard, Sparkles, Sprout, Swords, UsersRound } from "lucide-react";
...
const navLinks = [
    ...
    { href: "/dashboard/garden", label: "Garden Levels", icon: Sprout },
                    ...
                    <Sidebar collapsible="icon">
                        ...
                        <SidebarFooter className="border-t-2 border-border bg-secondary-background px-2 py-3 text-sm font-semibold">
                            <div className="flex flex-col gap-1">
                                <span className="text-xs uppercase text-foreground/60">Admin</span>
