...
const Table = React.forwardRef<HTMLTableElement, React.HTMLAttributes<HTMLTableElement>>(
    ({ className, ...props }, ref) => (
        <div className="relative w-full overflow-auto">
            <table
                ref={ref}
                className={cn("w-full caption-bottom border-border border-2 text-sm", className)}
                {...props}
            />
        </div>
    )
...
>(({ className, ...props }, ref) => (
    <caption ref={ref} className={cn("mt-4 text-sm text-mtext font-base", className)} {...props} />
));
